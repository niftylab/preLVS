...
mdata, vdata = flatten_v2(libname, cellname, cell_data, db_data, config_data, orientation_list, source_net_sets)
...
cinfo = check_and_report_connections_bfs(cgraph, source_net_sets, libname, cellname)
