#########################################################
#                                                                   
# Inverter for TDC-DCDL Ncap with PMOS switch (small)
# Contributors: J. Han    
...
# Design Variables
cellname = 'tdc_dcdl_ncap_psw_small'
nf = 2
# Design hierarchy
...
in0 = tnmos.generate(name='MN0_core', params={'nf': nf, 'tie': 'S'}, netmap={'G':'VSS:', 'D':'VSS:', 'I':'VSS:', 'RAIL':'VSS:'})
dsn.place(inst=[[in0], [ip0]])
# Route wires
# - in0 to VSS
dsn.route(grid=r12, mn=[in0.p['G'],in0.p['RAIL']],via_tag=[False,True])
_mn = ip0.p['G'].left
...
pCPLUS0 = dsn.pin(name='cplus', mn=ip0.p['D'])
# Export design
