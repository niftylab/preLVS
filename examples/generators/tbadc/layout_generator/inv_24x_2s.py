...
for celltype in cell_type:
    ...
    # core devices 
    inv_12x_0  = logic_lib['inv_12x'].generate(name='inv_12x_0')
    inv_12x_1  = logic_lib['inv_12x'].generate(name='inv_12x_1', transform='MX')
    
    # 4. Place instances
    dsn.place(grid=pg, inst=inv_12x_0, mn=[0,0])
    dsn.place(grid=pg, inst=inv_12x_1, mn=pg.mn.top_left(inv_12x_0)+pg.mn.height_vec(inv_12x_1))
            
    # 5. Create and place wires.
    print("Create wires")
    
    #IN
    _mn = [r23.mn(inv_12x_0.pins['I'])[0], r23.mn(inv_12x_1.pins['I'])[1]]
    rin0 = dsn.route(grid=r23, mn=_mn, via_tag=[False, False])
    
    #OUT
    _mn = [r23.mn(inv_12x_0.pins['O'])[0], r23.mn(inv_12x_1.pins['O'])[1]]
    rout0 = dsn.route(grid=r23, mn=_mn, via_tag=[False, False])
    ...
    pina0 = dsn.pin(name='I', grid=r23, mn=rin0)
