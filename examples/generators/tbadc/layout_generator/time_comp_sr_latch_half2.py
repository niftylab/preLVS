##########################################################
#                                                      
# sr_latch_high_half2 Layout Generator          
...
cellname = f'time_comp_sr_latch_half2'
...
g0 = dsn.via(grid=r34, mn=[r34(pdmy1.p['D0'])[0]+[0,-2]])
g0 = dsn.via(grid=r34, mn=[r34(ip4.p['G0'])[1]+[1,0]])
