...
function flatten(rootNode::TreeNode{NodeData}, cell_data::Dict, metal_dir::String, via_dir::String, db_path::String, config_path::String)
    ...
    function _create_merged_metal_dict(node::TreeNode{NodeData})
        ...
        elseif node.children == []
            ...
            memory_metal[libname][cellname] = db_to_MData(libname, cellname, db_json_data[libname][cellname]["metals"], true)
