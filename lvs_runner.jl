...
# Set variables
db_dir = workdir * "\\output\\db"
log_dir = workdir * "\\output\\out\\log"
...
# Include files
include(lvsdir * "\\main_functions_test.jl") # main functions ver2
include(lvsdir * "\\structs\\connectivity.jl")
include(lvsdir * "\\utils\\log.jl")
