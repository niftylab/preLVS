...
cellname = 'edge_selector_nand2_balanced'
...
rc.add_trunk(name="rN0", index=[None, in0.p['D'].bottom.n],    netname="N0")
rc.add_trunk(name="rN1", index=[None, in1.p['D'].bottom.n],    netname="N1")
