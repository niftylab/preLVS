...
# Design Variables
cellname = 'tdc_dcdl_filler_dmy_2x'
# Design hierarchy
...
ndmy0 = templates['nmos4_fast_dmy_nf2'].generate(name='ndmy0', netmap={'RAIL':'VSS:'})
pdmy0 = templates['pmos4_fast_dmy_nf2'].generate(name='pdmy0', transform='MX', netmap={'RAIL':'VDD:'})
