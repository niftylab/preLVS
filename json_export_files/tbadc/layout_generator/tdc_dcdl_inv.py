...
in0  = tnmos.generate(name='MN0',                 params={'nf': nf, 'tie': 'S' , 'nfdmyl' : 2}, netmap={'G':'I', 'D':'O', 'RAIL':'VSS:'})
ip0  = tpmos.generate(name='MP0', transform='MX', params={'nf': nf, 'tie': 'S' , 'nfdmyl' : 2}, netmap={'G':'I', 'D':'O', 'RAIL':'VDD:'})
