...
cmp0 = tlib['async_latch_half'].generate(name='cmp0', transform='MY')
cmp1 = tlib['async_latch_half'].generate(name='cmp1', transform='R180')
...
# test jSON DB export
grid_table = dict()
grid_table['M1'] = r12f # M1 uses r12f (r12cmf, r12m)
grid_table['M2'] = r23f # M2 uses r23f (r23cmf, r23m)
grid_table['M3'] = r34 # M3 uses r34
grid_table['M4'] = r34
